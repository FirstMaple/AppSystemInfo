...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" modelAttribute="appInfo" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				...
				<img id="showImg" width="100px" height="100px">
				<input id="attach"  type="file" class="form-control col-md-7 col-xs-12" name="a_idPicPath">
